...
export default function SuperAdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1926] flex items-center justify-center p-8">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3 rounded-lg bg-[#0f1926] text-white font-semibold hover:bg-[#1a2a3f] transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
      ...
      {resetOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40" onClick={() => setResetOpen(false)}>
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <label htmlFor="super-reset-email" className="sr-only">Super admin email for password reset</label>
            <input id="super-reset-email" type="text" value={resetEmail} onChange={e => setResetEmail(e.target.value)}
            ...
            <div className="flex justify-end gap-3">
              ...
              <button disabled={resetSending || !resetEmail} onClick={async () => {
                ...
                className="px-4 py-2 rounded-lg bg-[#0f1926] text-white text-sm font-semibold disabled:opacity-50">
