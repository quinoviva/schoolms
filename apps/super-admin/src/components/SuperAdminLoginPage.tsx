...
export default function SuperAdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#050a14] via-[#0a1628] to-[#0f1e3a] flex items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-card rounded-2xl shadow-2xl shadow-black/30 border border-white/5 p-8 relative">
